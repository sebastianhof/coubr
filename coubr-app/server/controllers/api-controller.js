...
module.exports = function (model) {
    ...
    return {
        explore: function (req, res) {
            ...
            model.Store.geoNear(point, {
                maxDistance: data.d / EARTH_RADIUS,
                spherical: true,
        ...
        store: function (req, res) {
            ...
            model.Store.findOne({'_id': id}, function (err, store) {
                ...
                if (!store) {
                    res.status(400).json(error("10001"));
                    return;
                }
        ...
        redeemCoupon: function (req, res) {
            ...
            model.Coupon.findOne({'_id': id}, function (err, coupon) {
                ...
                if (!coupon) {
                    res.status(400).json(error("10002"));
                    return;
                }
                ...
                model.Store.findOne({'_id': storeId}, function (err, store) {
                    ...
                    if (store.code != data.sc) {
                        res.status(400).json(error("10003"));
                        return;
                    }
        ...
        subscribe: function (req, res) {
            ...
            mc.lists.subscribe({id: '6a51717866', email: {email: data.email}}, function (data) {
