...
#ifndef coubr_coubrLocale_h
#define coubr_coubrLocale_h
...
#define LOCALE_PROFILE_NAV_FAVORITES NSLocalizedString(@"Favorites", nil)
#define LOCALE_PROFILE_NAV_VISITS NSLocalizedString(@"Visits", nil)
