...
public class StoreService {
    ...
    public byte[] getStoreQRCode(String email, String storeId, int dimension) throws StoreNotFoundException, EmailNotFoundException, QRCodeGenerationException {
        LocalBusinessEntity entity = getLocalBusinessEntity(email, storeId);
        return codeService.generateQRCode(entity.getStoreCode(), CodeService.CodeType.STORE, dimension);
    }
    ...
    public Store addStore(String email, AddStore data) throws EmailNotFoundException, PostalCodeNotFoundException, TypeNotFoundException, CategoryNotFoundException
    ...
    public void changeStoreLocation(String email, String storeId, StoreLocation data) throws EmailNotFoundException, StoreNotFoundException {
        LocalBusinessEntity entity = getLocalBusinessEntity(email, storeId);
        entity.setGeoLatitude(data.getLatitude());
        entity.setGeoLongitude(data.getLongitude());
        localBusinessRepository.save(entity);
    }
    ...
    private LocalBusinessEntity getLocalBusinessEntity(String email, String storeId) throws StoreNotFoundException, EmailNotFoundException {
        BusinessOwnerEntity businessOwnerEntity = getBusinessOwnerEntity(email);
        LocalBusinessEntity entity = localBusinessRepository.findOne(ObfuscationUtil.decode(storeId, ObfuscationUtil.SALT_LOCAL_BUSINESS));
