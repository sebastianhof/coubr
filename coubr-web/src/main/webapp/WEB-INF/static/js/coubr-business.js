...
coubrBusiness.controller('FeedbackInstanceController', ['$scope', '$modalInstance', function ($scope, $modalInstance) {
            ...
            scope.$on('error', function (event, error) {
                ...
                if (error.status) {
                    ...
                    if (error.status == 400) {
                        ...
                        if (error.data && error.data.code) {
                            ...
                            switch (error.data.code) {
                                ...
                                case '40007':
                                    ...
                                    break;
                                case '40008':
                                    text('postalCodeNotFound', 'Invalid Request. Postal code not found.');
                                    break;
                                case '40009':
                        ...
                        // not found
                        text('notFound', 'An error occurred. Some data not loaded.');
